...
const APARTMENTS = [
  ...
  { name: "The Arbors Apartments", address: "1280 Olive Dr", lat: 38.5415, lng: -121.7370, area: "Downtown", type: "General", beds: "1-2", rentLow: 1700, rentHigh: 2400, amenities: ["Pool", "Fitness", "Laundry", "Clubhouse", "Parking"], pet: true, units: 80, built: 1980, mgmt: "Private" },
  ...
  { name: "Sherwood & Forest Arms", address: "1411 Wake Forest Dr", lat: 38.5474, lng: -121.7479, area: "Central", type: "General", beds: "1-2", rentLow: 1895, rentHigh: 2195, amenities: ["Pool", "Laundry", "Parking"], pet: true, units: 55, built: 1972, mgmt: "Private" },
  { name: "Pennsylvania Place", address: "1523 Wake Forest Dr", lat: 38.5480, lng: -121.7479, area: "Central", type: "General", beds: "1-2", rentLow: 1600, rentHigh: 2200, amenities: ["Laundry", "Parking"], pet: true, units: 30, built: 1975, mgmt: "Private" },
  ...
  { name: "MarCo at the Cannery", address: "1575 Cannery Loop", lat: 38.5620, lng: -121.7430, area: "North", type: "General", beds: "1-2", rentLow: 2200, rentHigh: 3300, amenities: ["Pool", "Fitness", "W/D In-Unit", "Dog Park", "Clubhouse", "EV Charging", "Modern"], pet: true, units: 120, built: 2018, mgmt: "FPI Management" },
  { name: "Greystone Apartments", address: "515 Alvarado Ave", lat: 38.5570, lng: -121.7485, area: "North", type: "General", beds: "1-2", rentLow: 1600, rentHigh: 2400, amenities: ["Pool", "Spa", "Laundry", "Parking"], pet: true, units: 60, built: 1980, mgmt: "Private" },
  { name: "Alvarado Parkside", address: "520 Alvarado Ave", lat: 38.5571, lng: -121.7488, area: "North", type: "General", beds: "2", rentLow: 2100, rentHigh: 2500, amenities: ["Pool", "Laundry", "Parking"], pet: true, units: 40, built: 1978, mgmt: "Private" },
  { name: "Cambridge House Apartments", address: "818 Alvarado Ave", lat: 38.5582, lng: -121.7485, area: "North", type: "General", beds: "2-3", rentLow: 1700, rentHigh: 2700, amenities: ["Pool", "Laundry", "Parking", "Bike Storage"], pet: true, units: 50, built: 1975, mgmt: "Private" },
  ...
  { name: "Clearwater Apartments", address: "4141 Cowell Blvd", lat: 38.5315, lng: -121.7440, area: "South", type: "General", beds: "1-2", rentLow: 1795, rentHigh: 2395, amenities: ["Pool", "Laundry", "Parking", "Shuttle"], pet: false, units: 80, built: 1975, mgmt: "Private" },
  { name: "Sharps & Flats", address: "1660 Drew Cir", lat: 38.5330, lng: -121.7355, area: "South", type: "Student", beds: "2-4", rentLow: 1750, rentHigh: 2950, amenities: ["Pool", "Fitness", "Laundry", "Study Lounge", "WiFi", "Parking"], pet: true, units: 100, built: 1990, mgmt: "FPI Management" },
  { name: "Sorrento Apartments", address: "1500 Valdora St", lat: 38.5335, lng: -121.7320, area: "South", type: "General", beds: "2-4", rentLow: 1900, rentHigh: 3200, amenities: ["Pool", "Fitness", "Laundry", "Parking", "Clubhouse"], pet: true, units: 80, built: 2000, mgmt: "FPI Management" },
  { name: "Avalon Apartments", address: "1617 Valdora St", lat: 38.5340, lng: -121.7330, area: "South", type: "General", beds: "3-4", rentLow: 1200, rentHigh: 3999, amenities: ["Pool", "Fitness", "Laundry", "Parking", "Balcony", "Patio"], pet: true, units: 44, built: 2000, mgmt: "FPI Management" },
  { name: "El Macero Apartments", address: "4735 Cowell Blvd", lat: 38.5305, lng: -121.7380, area: "South", type: "General", beds: "1-2", rentLow: 1910, rentHigh: 2600, amenities: ["Pool", "Laundry", "Parking", "Renovated"], pet: true, units: 70, built: 1980, mgmt: "Private" },
  { name: "Oakshade Commons", address: "1550 Drew Cir", lat: 38.5333, lng: -121.7345, area: "South", type: "General", beds: "1-2", rentLow: 1600, rentHigh: 2400, amenities: ["Pool", "Laundry", "Parking"], pet: true, units: 60, built: 1985, mgmt: "Private" },
  ...
  { name: "Stonegate Village", address: "850 Cranbrook Ct", lat: 38.5500, lng: -121.7600, area: "West", type: "General", beds: "1-3", rentLow: 1800, rentHigh: 2700, amenities: ["Pool", "Fitness", "Laundry", "BBQ", "Parking"], pet: true, units: 120, built: 1985, mgmt: "Private" },
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div style={{ padding: "4px 14px", borderRadius: 20, background: t.badgeBg, border: `1px solid ${t.badgeBorder}`, fontSize: 10, fontWeight: 700, color: t.badgeText, textTransform: "uppercase", letterSpacing: 1.5 }}>
              MDC INSIDER - Market Intelligence
            </div>
          </div>
